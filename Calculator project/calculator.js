...
const Calculator = {
    ...
    First_Operand: null,
    //this checks whether or not the second oeprand has been input
...
function Input_Decimal(dot) {
    // this ensures that accidental clicking of the decimal point does not cause bugs in your operation
...
function Handle_Operator(Next_Operator) {
    ...
    //when an oeprator key is pressed, we convert the current number displayed on the screen to a number and then store the result in Calculator.First_Operand if it doesn't already exist
