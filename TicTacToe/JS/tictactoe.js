...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(Element => Element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active player may only be 'X' or 'O' sp, if not 'X' it must be 'O'
          }  else {
            ...
            //this class a function to check for any win conditions.
            checkWinConditions();
...
//this function parses the slectedSquares array to seatch for the win conditions.
...
function checkWinConditions() {
    ...
    if   (arrayIncludes('OX', '1X', '2X')) { drawWinLine(50, 100, 558, 100) }
      ...
      // X 2, 5, 8 condition.
      else  if   (arrayIncludes('2X', '5X', '8X')) { drawWinLine(100, 100, 520, 520) }
        // X 6, 4, 2 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //this line gives us access to methods and propertues to use on cavas 
...
function animationLineDrawing() {
    ...
    c.beginPath();
    // this methodmoves us to a starting point for our line.
    c.moveTo(x1, y1)
...
audio('./media/letsgo.mp3');
//this line calls our main animation loop.
animationLineDrawing();
//this line waits 1 second. thenm clears canvas, resets game, and allows clicking again
